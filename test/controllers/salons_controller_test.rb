...
class SalonsControllerTest < ActionController::TestCase
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post :create, salon: { owner_email: @salon.owner_email, salon_email: @salon.salon_email, salon_name: @salon.salon_name }
    end
  ...
  test "should update salon" do
    patch :update, id: @salon, salon: { owner_email: @salon.owner_email, salon_email: @salon.salon_email, salon_name: @salon.salon_name }
    assert_redirected_to salon_path(assigns(:salon))
  end
