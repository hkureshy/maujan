...
class DiscountsControllerTest < ActionController::TestCase
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post :create, discount: { discount_date: @discount.discount_date, discount_percent: @discount.discount_percent, discount_time: @discount.discount_time, service_id: @discount.service_id }
    end
  ...
  test "should update discount" do
    patch :update, id: @discount, discount: { discount_date: @discount.discount_date, discount_percent: @discount.discount_percent, discount_time: @discount.discount_time, service_id: @discount.service_id }
    assert_redirected_to discount_path(assigns(:discount))
  end
