...
class StylistsControllerTest < ActionController::TestCase
  ...
  test "should create stylist" do
    assert_difference('Stylist.count') do
      post :create, stylist: { branch_id: @stylist.branch_id, category: @stylist.category, name: @stylist.name }
    end
  ...
  test "should update stylist" do
    patch :update, id: @stylist, stylist: { branch_id: @stylist.branch_id, category: @stylist.category, name: @stylist.name }
    assert_redirected_to stylist_path(assigns(:stylist))
  end
