...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { area: @branch.area, city: @branch.city, salon_id: @branch.salon_id, service: @branch.service }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { area: @branch.area, city: @branch.city, salon_id: @branch.salon_id, service: @branch.service }
    assert_redirected_to branch_path(assigns(:branch))
  end
